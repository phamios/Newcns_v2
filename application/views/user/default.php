        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a href="#" class="brand">
                       <img width="94" height="45" alt="logo payz" src="<?php  echo base_url('themes/home/payz_files/logo.png');?>">
                         USER CONTROL PANEL</small> </a>
        ...
        <div class="main-container container-fluid">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                     <div class="row-fluid">
								<div class="span6"> 
									<h2>Soạn tin: <span style="color:red">GKD <?php echo $your_id?></span> gửi: <span style="color:red">6757</span> để kích hoạt VIP</h2>
