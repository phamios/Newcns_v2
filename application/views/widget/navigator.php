...
<!--                             <li><a href="form-wizard.html"><i class="icon-angle-right"></i> Wizard &amp; File Upload</a></li> -->
                    ...
                    <li><a href="table.html"><i class="icon-table icon-large"></i>  Quản lý user</a></li>
                    <li><a href="file.html"><i class="icon-file icon-large"></i> Quản lý  giao dịch</a></li>
                    <li><a href="typography.html"><i class="icon-font icon-large"></i> Quản lý  nạp tiền</a></li>
                    <li><a href="maps.html"><i class="icon-map-marker icon-large"></i> Quản lý rút tiền</a></li>
