...
<div id="logged-in-component-tos_update"></div>
<div id="logged-in-component-meganav">		
</div>
<div id="logged-in-component-footer-components"></div>	
...
<script type="text/javascript">
    ...
    $('#rev_cate li').bind('mouseover',function(e){
        alert("ok");
    });
