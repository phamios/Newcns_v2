<section id="river" class="standard">
    <?php $this->load->view('home/widget/breakcrum');?> 
    <!--DTC HTML CACHE HIT START-->			
    <?php if($features <> null):?>
    <?php foreach($features as $content):?>
    <div class="post " data-post-type="post">
        <div class="thumb"> 
            <a href="<?php echo site_url('home/features/'.mb_strtolower(url_title(removesign($content->post_title.'-'.$content->id))).'.html' );?>">
                <span class="image-holder">
                    <img src="<?php echo site_url('src/features/thumb_'.$content->post_images)?>" alt="<?php echo $content->post_title?>"/>
                </span>							
            </a>
        </div>
