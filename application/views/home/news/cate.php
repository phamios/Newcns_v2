        ...
        <div class="bb-wrap"> 
            ...
            <div id="primary-wrap" style="padding-top:0px;" class="full-width-header-media">
                ...
                <div class="header-media image full-width">
                    <a href="<?php echo base_url('src/post/' . $content->post_images); ?>" rel="post">
                        <img src="<?php echo base_url('src/post/' . $content->post_images); ?>" alt="<?php echo $content->post_title ?>" width="50%" />
                    </a>
