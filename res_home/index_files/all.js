/*1399772289,179390537,JIT Construction: v1243607,en_US*/
    ...
    window.FB || (function(window) {
        ...
        __d("ES5ArrayPrototype",[],function(a,b,c,d,e,f){
            ...
            g.map=function(h,i){
                ...
                for(j=0;j<k;++j)if(j in this)l[j]=h.call(i,this[j],j,this);return l;
            };
            ...
            g.every=function(h,i){
                ...
                for(var l=0;l<k;l++)if(l in j)if(!h.call(i,j[l],l,j))return false;return true;
            };
            
            g.some=function(h,i){
                if(typeof h!='function')throw new TypeError();
                var j=new Object(this),k=j.length;
                for(var l=0;l<k;l++)if(l in j)if(h.call(i,j[l],l,j))return true;return false;
            };
            ...
            g.indexOf=function(h,i){
                ...
                i|=0;
                if(i<0)i+=j;
                for(;i<j;i++)if(i in this&&this[i]===h)return i;return -1;
            };
        ...
        __d("ES5Object",[],function(a,b,c,d,e,f){
            ...
            g.keys=function(h){
                ...
                var j=[];
                for(var k in h)if(Object.prototype.hasOwnProperty.call(h,k))j.push(k);var l=!({
                    toString:true
...
i=function(ga,ha){
    ...
    ka=new ja();
    for(la in ka)if(h.call(ka,la))ia++;ja=ka=null;
    if(!ia){
        ...
        ma=function(na,oa){
            ...
            for(qa in na)if(!(pa&&qa=="prototype")&&h.call(na,qa))oa(qa);for(ra=ka.length;qa=ka[--ra];h.call(na,qa)&&oa(qa));
        };
    ...
    var pa=g.call(na)=="[object Function]",qa,ra;
    for(qa in na)if(!(pa&&qa=="prototype")&&h.call(na,qa)&&!(ra=qa==="constructor"))oa(qa);if(ra||h.call(na,(qa="constructor")))oa(qa);
};
...
if(!m){
    ...
    q=function(ga,ha,ia,ja,ka,la,ma){
        ...
        if(typeof na=="object"){
            for(ab=ma.length;ab--;)if(ma[ab]===na)throw TypeError();ma.push(na);
            xa=[];
            bb=la;
            la+=ka;
            if(oa=="[object Array]"){
...
__d("ES5",["ES5ArrayPrototype","ES5FunctionPrototype","ES5StringPrototype","ES5Array","ES5Object","ES5Date","JSON3"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){
    var n=Array.prototype.slice,o=Object.prototype.toString,p={
...
__d("copyProperties",[],function(a,b,c,d,e,f){
    function g(h,i,j,k,l,m,n){
        ...
        while(o[p]){
            q=o[p++];
            for(var r in q)h[r]=q[r];if(q.hasOwnProperty&&q.hasOwnProperty('toString')&&(typeof q.toString!='undefined')&&(h.toString!==q.toString))h.toString=q.toString;
        }
        return h;
    }
    e.exports=g;
...
__d("Type",["copyProperties","Assert"],function(a,b,c,d,e,f,g,h){
    ...
    function j(m,n){
        ...
        if(n instanceof i)for(var o=0;o<n.__mixins.length;o++)if(n.__mixins[o]==m)return true;return false;
    }
    function k(m,n){
        var o=m.prototype;
...
__d("sdk.createIframe",["copyProperties","guid","hasNamePropertyBug","DOMEventListener"],function(a,b,c,d,e,f,g,h,i,j){
    function k(l){
        ...
        delete s.height;
        delete s.width;
        for(var t in s)if(s.hasOwnProperty(t))m.setAttribute(t,s[t]);g(m.style,p);
...
__d("URISchemes",["createObjectFrom"],function(a,b,c,d,e,f,g){
    var h=g(['fb','fbcf','fbconnect','fb-messenger','fbrpc','file','ftp','http','https','mailto','ms-app','itms','itms-apps','itms-services','market','svn+ssh','fbstaging','tel','sms']),i={
...
__d("ex",["eprintf"],function(a,b,c,d,e,f,g){
    var h=function(){
        ...
        if(i[0].split('%s').length!==i.length)return h('ex args number mismatch: %s',ES5('JSON','stringify',false,i));
...
__d("Flash",["DOMEventListener","DOMWrapper","QueryString","UserAgent","copyProperties","guid","htmlSpecialChars"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){
    ...
    var u={
        embed:function(v,w,x,y){
            ...
            var aa=[];
            for(var ba in x)if(x.hasOwnProperty(ba)&&x[ba])aa.push('<param name="'+m(ba)+'" value="'+m(x[ba])+'">');var ca=w.appendChild(p.createElement('span')),da='<object '+(j.ie()?'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ':'type="application/x-shockwave-flash"')+'data="'+v+'" '+(x.height?'height="'+x.height+'" ':'')+(x.width?'width="'+x.width+'" ':'')+'id="'+z+'">'+aa.join('')+'</object>';
            ca.innerHTML=da;
...
__d("sdk.XD",["sdk.Content","sdk.Event","Log","QueryString","Queue","sdk.RPC","sdk.Runtime","sdk.Scribe","sdk.URI","UrlMap","JSSDKXDConfig","XDM","sdk.createIframe","sdk.feature","guid"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u){
    var v=new k(),w=new k(),x=new k(),y,z,aa=u(),ba=q.useCdn?'cdn':'www',ca=t('use_bundle')?q.XdBundleUrl:q.XdUrl,da=p.resolve(ba,false)+ca,ea=p.resolve(ba,true)+ca,fa=u(),ga=location.protocol+'//'+location.host,ha,ia=false,ja='Facebook Cross Domain Communication Frame',ka={},la=new k();
    l.setInQueue(la);
    function ma(sa){
...
function qa(sa){
    if(ia)return;
    var ta=g.appendHidden(document.createElement('div')),ua=r.create({
        blacklist:null,
        root:ta,
        channel:fa,
...
function ba(ea){
    ...
    var ha=aa(ea,v,'login_status'),ia=t(s.resolve('www',true)+'/connect/ping').setQueryData({
...
function s(z,aa,ba){
    ...
    for(var ea=0,fa=ca.length;ea<fa;ea++)if(p(ca[ea],z))da[da.length]=ca[ea];return da;
}
function t(z,aa){
    g.isTruthy(z,'element not specified');
    g.isString(aa);
...
__d("sdk.ErrorHandling",["sdk.feature","ManagedError","sdk.Runtime","sdk.Scribe","UserAgent","wrapFunction"],function(a,b,c,d,e,f,g,h,i,j,k,l){
    ...
    function p(u){
        ...
        for(var w in v)(v[w]==null&&delete v[w]);return v;
    }
    function q(u,v){
        return function(){
...
var w=n.extend({
    ...
    trackEvents:function(y){
        ...
        for(var z in y)if(y.hasOwnProperty(z))this.trackEvent(z,y[z]);return this;
    }
},l),x={
...
'login.status':{
    ...
    checkOauthDisplay:function(fa){
        ...
        var ha=ga.split(/\s|,/g);
        for(var ia=0;ia<ha.length;ia++)if(!y.initSitevars.iframePermissions[ES5(ha[ia],'trim',true)])return 'popup';return fa.display;
    },
...
__d("mergeArrays",[],function(a,b,c,d,e,f){
    function g(h,i){
        for(var j=0;j<i.length;j++)if(ES5(h,'indexOf',true,i[j])<0)h.push(i[j]);return h;
    }
    e.exports=g;
});
...
var n=1,o=j.extend({
    ...
    parse:function(p){
        ...
        this.table=r[2];
        this.where=l(r[3]);
        for(var s=1;s<p.length;s++)if(i.instanceOf(o,p[s]))p[s].hasDependency(true);return this;
    },
    toFql:function(){
...
__d("sdk.Data",["sdk.api","sdk.ErrorHandling","mergeArrays","sdk.Query","safeEval","sdk.Waitable"],function(a,b,c,d,e,f,g,h,i,j,k,l){
    var m={
        ...
        for(var t in o)if(o.hasOwnProperty(t))s.q[t]=o[t].toFql();if(n)s.access_token=n;
...
__d("PluginPipe",["sdk.Content","copyProperties","sdk.feature","guid","insertIframe","Miny","ObservableMixin","JSSDKPluginPipeConfig","sdk.Runtime","UrlMap","UserAgent","XFBML"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r){
    ...
    function w(){
        ...
        ES5(y,'forEach',true,function(ba){
            ...
            for(var da in ba.config)ca[da]=ba.config[da];ca.url=p.resolve('www',o.getSecure())+'/plugins/plugin_pipe_shell.php';
            ca.onload=aa;
            k(ca);
        });
        aa();
...
__d("sdk.XFBML.ConnectBar",["sdk.Anim","sdk.api","sdk.Auth","createArrayFrom","JSSDKConnectBarConfig","sdk.Data","sdk.DOM","sdk.XFBML.Element","escapeHTML","sdk.Event","format","sdk.Helper","sdk.Insights","sdk.Intl","sdk.Runtime","UrlMap","UserAgent"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w){
    ...
    _clickHandler:function(y){
        ...
        switch(z.className){
            ...
            this._closeConnectBar();
                break;
            case 'fb_learn_more':case 'fb_profile':
                window.open(z.href);
                break;
            case 'fb_no_thanks':
                this._closeConnectBar();
...
__d("legacy:fb.xfbml-legacy",["FB","sdk.Event"],function(a,b,c,d,e,f,g,h){
    ...
    new Image().src="http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1243607","message":"'+e.message+'"}}');
}