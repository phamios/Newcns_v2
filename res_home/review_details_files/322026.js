var flxpxlObj = (function() {
	...
	obj.execute = function() {
		...
		var conditions_306481 = {};
		setTimeout(function() {
		function pageGroup_306481() {
			obj.placeAppNexusSegmentScript('seg?add=1490648&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_306481[queryId]=true);if(checkConditions(conditions_306481)){pageGroup_306481();}});};
		if(
			(window.location.href.indexOf('') != -1)
		) {
			if(checkConditions(conditions_306481)){pageGroup_306481();}
		}
		}, 1);

		// Page group: Organic
		var conditions_306482 = {};
		setTimeout(function() {
		function pageGroup_306482() {
			obj.placeAppNexusSegmentScript('seg?add=1490649&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_306482[queryId]=true);if(checkConditions(conditions_306482)){pageGroup_306482();}});};
		if(
			(flxKeyword != '')
		) {
			if(checkConditions(conditions_306482)){pageGroup_306482();}
		}
		}, 1);
...
function flxSendKeyword(keyword) {
	if(keyword) {
		if(!keywordsSent[keyword]) {
			sendRequest('//ib.adnxs.com/getuid?https://dm6ndb2k9edja.cloudfront.net/k.gif?pubID=322026&' + '&keyword=' + encodeURIComponent(keyword) + '&AnId=$UID' + '&url=' + encodeURIComponent(window.location.href.split('#')[0].split('?')[0].substring(0,500)) + '&ref=' + encodeURIComponent(document.referrer.substring(0, 500)));
